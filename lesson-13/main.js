...
const port = 3000,
  ...
  dbURL = "mongodb+srv://limuisoon:11enVCWHvjqJM6DU@ut-node.mpzg08n.mongodb.net/?retryWrites=true&w=majority&appName=ut-node",  //Atlas
  dbName = "ut-node";
  // @TODO: 몽고DB 모듈의 요청
...
.catch((error) => {
  console.log("DB connection FAILDED!");
  console.log(error);
  process.exit(1);
});
